Feature: test interpretation resources endpoints
    ...
    Scenario: test a empty resource
        Given the resource endpoint planet_house.
            and planet as a query param.
            and house as a query param.
            and $random_planet is the planet.
            and $random_house is the house.
