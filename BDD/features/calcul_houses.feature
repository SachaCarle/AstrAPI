...
Scenario: setup request and result
    Given the endpoint chart_houses.
...
Scenario: assert result format
    Then assert the result contains "1" key.
        and assert the result contains "2" key.
        and assert the result contains "3" key.
        and assert the result contains "4" key.
        and assert the result contains "5" key.
        and assert the result contains "6" key.
        and assert the result contains "7" key.
        and assert the result contains "8" key.
        and assert the result contains "10" key.
        and assert the result contains "11" key.
        and assert the result contains "12" key.
